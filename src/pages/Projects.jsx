...
const Projects = () => {
  return (
    <section id="projects" className="min-h-screen py-24 px-6 text-white flex flex-col items-center">
      <h1 className="text-4xl font-semibold font-serif italic tracking-wider text-yellow-300/90 mt-5">
        PROJECTS
      </h1>
      <div className="w-25 h-1 bg-yellow-300/90 rounded mb-10 -ml-30"></div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 w-full max-w-7xl">
        {projects.map((proj, index) => (
          <motion.div
            ...
            className="relative overflow-hidden m-3 rounded-xl shadow-[0_0_40px_rgba(0,255,255,0.08)] border border-cyan-300/20 bg-white/5 backdrop-blur-lg group mx-auto"
