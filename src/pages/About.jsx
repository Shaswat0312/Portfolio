...
>
  ...
  className="block mx-auto mt-6 max-w-[220px] px-8 py-3 rounded-full bg-black text-white border border-white font-semibold shadow-md hover:bg-neutral-700/90 hover:shadow-yellow-500/50 hover:text-white hover:border-black transition-colors duration-300 text-center">
  📄 Resume
      </motion.a>
    </motion.div>
  </div>
